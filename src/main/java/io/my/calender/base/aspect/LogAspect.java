package io.my.calender.base.aspect;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import io.my.calender.base.log.PayloadLog;
import io.my.calender.base.util.AspectUtil;
...
public class LogAspect {
    ...
    @Around(value = "@annotation(io.my.calender.base.annotation.Logger)")
