...
[[resources-calender-class-refuse]]
==== 수업 참가 취소 (거절)

include::{snippets}/classrestdocstest/refuseclass/request-parameters.adoc[]
include::{snippets}/classrestdocstest/refuseclass/response-fields.adoc[]
include::{snippets}/classrestdocstest/refuseclass/http-request.adoc[]
include::{snippets}/classrestdocstest/refuseclass/http-response.adoc[]
include::{snippets}/classrestdocstest/refuseclass/curl-request.adoc[]
